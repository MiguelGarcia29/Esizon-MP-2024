...
// Función para generar el ID de descuentos
char *generar_id_descuentos(Descuento *desc, int cantdad_desc);

// Función para encontrar un descuento por su ID
...
// Función para dar de alta un nuevo descuento
...
// Función para dar de baja un descuento
...
// Función para modificar un descuento
