...
// Definición de la estructura Locker para representar los lockers
typedef struct {
    char id_locker[11];     // Identificador único del locker
    char localidad[21];     // Localidad donde se encuentra el locker
    char provincia[21];     // Provincia donde se encuentra el locker
    char ubicacion[21];     // Dirección específica del locker
    int num_compt;          // Número total de compartimentos del locker
    int num_compocup;       // Número de compartimentos ocupados en el locker (no utilizado en el código actual)
} Locker;
